...
class CharacterCommentSystem {
    constructor(characterId) {
        ...
        this.userIdKey = 'aspen-user-id';
        this.userNameKey = 'aspen-user-name';
        this.comments = [];
        ...
        return `
            <div class="comments-header">
                ...
                <p class="comments-intro">
                    <strong>ASPEN CREW FEEDBACK TERMINAL:</strong> Share your thoughts about this character with other passengers. 
                    ${this.firebaseReady ? 
