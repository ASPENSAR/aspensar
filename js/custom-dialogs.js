/**
 * Custom Dialog System for ASPEN Theme
...
class CustomDialogs {
  ...
  createDialogHTML() {
    ...
    let logoPath = 'assets/logos/aspen-logo.png';
    ...
    if (currentPath.includes('/pages/') || currentPath.includes('/ariella/') || 
      ...
      logoPath = '../assets/logos/aspen-logo.png';
    }
      ...
      <div id="custom-dialog-container" class="dialog-overlay" style="display: none;">
        <div class="dialog-panel">
          <div class="dialog-header">
            <img src="${logoPath}" alt="ASPEN – Allied Security, Protection & Emergency Network" class="dialog-logo">
            <h1 id="dialog-title">🔒 ASPEN SYSTEM DIALOG</h1>
  ...
  // Custom Alert
  alert(message, title = '🔒 ASPEN SYSTEM ALERT', subtitle = 'System Notification') {
  ...
  // Custom Confirm
  confirm(message, title = '🔒 ASPEN SECURITY CONFIRMATION', subtitle = 'Action Confirmation Required') {
